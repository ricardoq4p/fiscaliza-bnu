...
export default function HomeClient({ dados }) {
  ...
  return <main>
    ...
    <section className="mapSection" id="mapa-obras"><div className="mapSectionIntro"><span>MAPA INTERATIVO</span><h2>Veja as obras públicas de Blumenau no mapa</h2><p>Explore a cidade, filtre por situação ou órgão responsável e selecione um ponto para identificar a obra.</p></div><WorksMap works={dados.obras} sourceUrl={dados.fonte}/></section>
